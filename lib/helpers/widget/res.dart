...
class RestaurantWidget extends StatelessWidget {
  ...
  const RestaurantWidget({required this.restaurant}) ;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Stack(
        children: <Widget>[
          _backgroundImage(restaurant.image.toString()),
          Padding(
        ...
        child: ClipRRect(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Center(
                  child: FadeInImage.memoryNetwork(placeholder: kTransparentImage, image: restaurant.image.toString()),
                )
              ],
            )),
      );
