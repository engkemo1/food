...
import 'package:foood/helpers/widget/Small%20Button.dart';
                ...
                children: <Widget>[
                  ...
                  ClipRRect(
                    ...
                    child: FadeInImage.memoryNetwork(
                      ...
                      image: restaurantModel.image.toString(),
                      height: 160,
                      fit: BoxFit.fill,
                  ...
                  Positioned.fill(
                      ...
                      child: Align(
                          alignment: Alignment.bottomCenter,
                          child:Text( "Average Price: \$" + restaurantModel.avgPrice.toString(),style:  TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w300,), ))),
...
//              open & book section
              Row(
                ...
                children: <Widget>[
                  Text( "Open",style: TextStyle(color: Colors.green,fontWeight: FontWeight.w400, fontSize: 18),),
                  Container(
                      child: FlatButton.icon(onPressed: (){}, icon: Icon(Icons.restaurant_menu), label:Text( "Book Now")))
                ],
              ),
